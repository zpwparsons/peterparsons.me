    ...
    <div class="flex-grow flex flex-col">
        <nav class="mt-5 flex-1 px-2 space-y-8 bg-white dark:bg-mirage" aria-label="Sidebar">
            <div class="space-y-2">
                ...
                <a href="https://twitter.com/PW_Parsons" target="_blank" rel="noopener noreferrer" class="text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-madison/50 hover:text-slate-900 dark:hover:text-slate-300 group flex items-center px-2 py-2 text-sm rounded-md text-base">
                    <span class="text-slate-400 dark:text-slate-500 mr-3 flex-shrink-0 h-4 w-4">
                ...
                <a href="https://github.com/zpwparsons" target="_blank" rel="noopener noreferrer" class="text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-madison/50 hover:text-slate-900 dark:hover:text-slate-300 group flex items-center px-2 py-2 text-sm rounded-md text-base">
                    <span class="text-slate-400 dark:text-slate-500 mr-3 flex-shrink-0 h-4 w-4">
