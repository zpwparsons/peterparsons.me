<div {{ $attributes }}>
    <button
        ...
        class="relative p-0.5 focus:outline-none focus:ring focus:ring-offset-2 dark:focus:ring-offset-mirage focus:ring-blue-600 dark:focus:ring-lime-500 rounded-md text-slate-400 dark:text-slate-500"
    >
